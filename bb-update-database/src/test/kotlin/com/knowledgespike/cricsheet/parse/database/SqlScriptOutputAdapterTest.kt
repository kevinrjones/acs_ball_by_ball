...
import com.knowledgespike.cricsheet.parse.database.adapter.mariadb.SqlScriptOutputAdapter
...
class SqlScriptOutputAdapterTest {
    ...
    fun `given postgres output when opened then postgres syntax is emitted`() {
        ...
        val sql = Files.readString(output)
        expectThat(sql).contains("CREATE SCHEMA IF NOT EXISTS cricsheet;")
        ...
        DriverManager.getConnection("jdbc:sqlite::memory:").use { connection ->
            connection.createStatement().use { statement ->
                ...
                statement.executeQuery(
                    ...
                    result.next()
                    expectThat(result.getInt(1)).isEqualTo(11)
                }
            }
        }
    }
