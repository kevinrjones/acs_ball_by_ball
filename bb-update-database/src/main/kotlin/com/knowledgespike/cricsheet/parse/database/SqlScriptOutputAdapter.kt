...
/** Writes an executable MariaDB SQL script while keeping warehouse keys stable within the script. */
class SqlScriptOutputAdapter(output: Path) : OutputAdapter {
    ...
    init {
        ...
        WarehouseSchemaSql.writeTo(writer)
