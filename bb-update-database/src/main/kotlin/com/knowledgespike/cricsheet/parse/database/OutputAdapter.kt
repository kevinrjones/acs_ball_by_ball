...
import com.knowledgespike.cricsheet.parse.parser.structure.Delivery
...
interface OutputAdapter : AutoCloseable {
    ...
    fun insertMatchFact(matchKey: Long, matchDateKey: Int?, groundKey: Long, durationDays: Int, margin: Int)
