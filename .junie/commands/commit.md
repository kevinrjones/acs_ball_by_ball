---
name: commit
description: Generate a conventional git commit message and commit the changes using git.
---

## Task
You are a Git expert helping me write a prompt that creates a solid Git commit message.
